					...
					<div class="col-lg-6 mb--30">
						<div class="row space-db--30">
                         ...
                         <div class="product-details-info pl-lg--30 ">
                            <h1 style="font-size:30px;" leclass="product-title">'.$name.'</h1>
                             <br>
                             <ul class="list-unstyled">
                                 <li>Tác giả: <span class="list-value">'.$author.'</span></li>
                                 <li>Số lượng tồn:  <a href="#" class="list-value font-weight-bold">'.$quantity.'</a></li>
                                 <li>Lượt mua : <span class="list-value">'.$luotmua.'</span></li>
...
<!-- Mirrored from htmldemo.net/pustok/pustok/product-details-left-gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 19 Nov 2023 16:46:23 GMT -->
</html>